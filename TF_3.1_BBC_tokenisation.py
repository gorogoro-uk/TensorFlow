...
print(len(sentences))
print(sentences[0])
# Expected output: 2225;    tv future hands viewers home theatre systems plasma high-definition ...
print("\nDataset preparation ok\n")

# tokenize text: create vocab list
tokenizer = Tokenizer(oov_token="<OOV>")
tokenizer.fit_on_texts(sentences)
word_index = tokenizer.word_index
print(len(word_index))
# Expected output: 29714

# padout token sequences
sequences = tokenizer.texts_to_sequences(sentences)
padded = pad_sequences(sequences, padding='post')
print(padded[0])
print(padded.shape)
# Expected output: [  96  176 1158 ...    0    0    0],  (2225, 2442)
print("\nText tokenizer ok\n")
